...
class ProjectAudioAssembler:
    def __init__(self, project_store, runtime_registry):
    ...
    def assemble_project_audio(self, project_id: str):
        ...
        for block in project["blocks"]:
            waveform, sample_rate = runtime.read_wav(Path(block["audio_path"]))
        ...
        final_waveform, sample_rate, timeline = runtime.concatenate_rendered_blocks(rendered_blocks)
        audio_bytes = runtime.write_final_wav(final_waveform, sample_rate)
